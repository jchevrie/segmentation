...
Some changes to these files had to be made in order to obtain the desired functionality. These include changes in function Get\+Regions in \mbox{\hyperlink{msImageProcessor_8cpp_source}{ms\+Image\+Processor.\+cpp}}\hypertarget{group__blobExtractor_lib_sec}{}\subsection{Libraries}\label{group__blobExtractor_lib_sec}
